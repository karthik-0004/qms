"""Gateway Service — Reverse proxy for audit-service routes."""
...
router = APIRouter(prefix="/audit", tags=["Audit (proxy)"])
...
async def proxy_audit(
    ...
    upstream_base = _join_url(settings.audit_service_url, "/api/v1/audit")

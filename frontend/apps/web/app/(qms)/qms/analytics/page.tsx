      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              {[
                { label: "Draft", count: 15, pct: 18, color: "bg-slate-400" },
                { label: "Under Review", count: 8, pct: 10, color: "bg-amber-400" },
                { label: "Approved", count: 52, pct: 62, color: "bg-green-500" },
                { label: "Obsolete", count: 9, pct: 10, color: "bg-red-400" },
              ].map((row) => (
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-3">
              {[
                { label: "0–30 days", count: 5, pct: 42, color: "bg-green-500" },
                { label: "31–60 days", count: 3, pct: 25, color: "bg-amber-400" },
                { label: "61–90 days", count: 2, pct: 17, color: "bg-orange-500" },
                { label: "90+ days", count: 2, pct: 17, color: "bg-red-500" },
              ].map((row) => (
                <div key={row.label} className="flex items-center gap-3">
                  <span className="text-sm text-muted-foreground w-28">{row.label}</span>
                  <div className="flex-1 h-2 bg-muted rounded-full overflow-hidden">

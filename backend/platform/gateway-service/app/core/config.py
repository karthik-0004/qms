...
class Settings(BaseSettings):
    ...
    audit_management_service_url: str = "http://audit-management-service:8025"
    env_monitoring_service_url: str = "http://env-monitoring-service:8026"
    risk_service_url: str = "http://risk-service:8027"
    pt_service_url: str = "http://pt-service:8028"
    complaints_service_url: str = "http://complaints-service:8029"
    management_review_service_url: str = "http://management-review-service:8030"

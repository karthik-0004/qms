"""Image Service — FastAPI application factory."""
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    logger.info("image_service.shutdown", service=settings.service_name)
...
def create_app() -> FastAPI:
    ...
    app = FastAPI(
        title="Image Service",
        description="EndGameBiotech — Plate Image Capture and Storage",
        version=settings.service_version,
        docs_url="/docs",
        redoc_url="/redoc",
        lifespan=lifespan,

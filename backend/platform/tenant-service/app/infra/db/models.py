...
class Tenant(Base):
    ...
    billing_profile: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
    primary_contact_first_name: Mapped[str | None] = mapped_column(String(100), nullable=True)
    primary_contact_last_name: Mapped[str | None] = mapped_column(String(100), nullable=True)
